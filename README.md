## aruco_ros (jade) - 0.2.0-0

The packages in the `aruco_ros` repository were released into the `jade` distro by running `/usr/bin/bloom-release aruco_ros --track jade --rosdistro jade --override-release-repository-url https://github.com/procopiostein/aruco_ros-release-1.git` on `Thu, 20 Oct 2016 10:14:56 -0000`
...
The packages in the `aruco_ros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release aruco_ros --track indigo --rosdistro indigo --override-release-repository-url https://github.com/procopiostein/aruco_ros-release-1.git --override-release-repository-push-url https://github.com/procopiostein/aruco_ros-release-1.git` on `Thu, 20 Oct 2016 10:00:09 -0000`
